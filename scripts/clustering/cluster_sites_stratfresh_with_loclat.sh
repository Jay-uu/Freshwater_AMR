...
#SBATCH -t 7-00:00:00 
#SBATCH -J clustering
#SBATCH -o /proj/fume/nobackup/private/jay/Freshwater_AMR/scripts/clustering/logs/clustering_sites_stratfresh_230526.log
#SBATCH -e /proj/fume/nobackup/private/jay/Freshwater_AMR/scripts/clustering/logs/clustering_sites_stratfresh_230526.err
...
for bin in $STRATFRESH_BINS/Loclat/*
do
echo "Extracting bin: $bin"
