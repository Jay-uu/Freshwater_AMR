...
#SBATCH -o /proj/fume/nobackup/private/jay/Freshwater_AMR/scripts/amr_finding/logs/nextflow230324.log #write slurm log name here
#SBATCH -e /proj/fume/nobackup/private/jay/Freshwater_AMR/scripts/amr_finding/logs/nextflow230324.err #write same slurm log name here
